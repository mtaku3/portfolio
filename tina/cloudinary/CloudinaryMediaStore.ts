// @ts-nocheck
import { E_UNAUTHORIZED, E_BAD_ROUTE, interpretErrorMessage } from "./error";
import type {
	Media,
	MediaList,
	MediaListOptions,
...
/**
 * Brought from https://github.com/tinacms/tinacms/blob/main/packages/next-tinacms-cloudinary/src/cloudinary-media-store.ts
